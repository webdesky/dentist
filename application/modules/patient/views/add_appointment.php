                        ...
                        <div class="col-lg-12 col-md-12">
                            <form role="form" method="post" action="<?php echo base_url('patient/addAppointment') ?>" class="registration_form1" enctype="multipart/form-data">
                                <div class=""> <label class="col-md-2">Doctor Name * </label>
                                    <div class="col-lg-6"> <select class="wide" name="doctor_id" id="doctor_id" onchange="getSchedule()">
                                ...
                                <div class="form-group"> <label class="col-md-2">Appointment Date * </label>
                                    <div class="col-lg-8">
                                        <div class="col-lg-4"> <input type="text" id="appointment_date" name="appointment_date" class="form-control date" autocomplete="off" readonly="readonly" placeholder="Start Date"> </div>
