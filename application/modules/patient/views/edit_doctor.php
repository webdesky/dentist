                    ...
                    <div class="row">
                        <div class="col-lg-6 col-lg-offset-2">
                            <form role="form" method="post" action="<?php echo base_url('admin/updateDoctor') ?>" class="registration_form" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Address *</label>
                                    <textarea class="form-control" rows="5" id="doctor_address" name="doctor_address" placeholder="Address">
                                        <?php  echo $data->doctor_address;?>
                                    </textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="summernote" class="form-control" id="doctor_biography" name="doctor_biography">
                                        <?php  echo $data->doctor_biography;?>
                                    </textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="education" class="form-control" id="doctor_qualification" name="doctor_qualification">
                                        <?php echo $data->doctor_qualification; ?>
                                    </textarea>
                                </div>
                                <div class="form-group">
                                    <label>Status</label>
