                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 table-responsive">
                                <form action="<?php echo base_url('pharma/edit_billing/'.$param)?>" class="registration_form1" method="post" accept-charset="utf-8">
                                    <!-- Information -->
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                        ...
                                                        <li>
                                                            <select name="patient_id" class="invoice-input form-control" onchange="get_patient_data(this.value)">
                                                                ...
                                                                <?php if(!empty($patient)){ foreach($patient as $value){
                                                                    echo $billed_patient_by_pharma[0]->id==$value->id;
                                                                    ?>
                                                                <option value="<?php echo $value->id;?>" <?php if(!empty($billed_patient_by_pharma[0]) && $billed_patient_by_pharma[0]->id==$value->id){ echo 'selected';}?>><?php echo ucwords($value->first_name.' '.$value->last_name);?></option>
                                                                <?php }}?>
                                                            </select>
                                                            <span class="red"><?php echo form_error('patient_id'); ?></span>
                                                        </li>
                                                        <li>
                                                            <input type="text" placeholder="Sex" class="invoice-input form-control" id="sex" name="sex" value="<?php if(!empty($billed_patient_by_pharma[0]->gender)){ echo $billed_patient_by_pharma[0]->gender;}?>" readonly="readonly">
                                                            <span class="red"><?php echo form_error('sex'); ?></span>
                                                        </li>
                                                        <li>
                                                            <input type="text" placeholder="Date of Birth" class="invoice-input form-control date" id="date_of_birth" name="date_of_birth" value="<?php if(!empty($billed_patient_by_pharma[0]->date_of_birth)){ 
                                                                echo date('Y-m-d',strtotime($billed_patient_by_pharma[0]->date_of_birth));}?>" readonly="readonly">
                                                ...
                                                <th width="33.33%">
                                                    <ul class="list-unstyled">
                                                        <li><input type="text" name="prescription_id" id="prescription_id" value="<?php if(!empty($billed_patient_by_pharma[0]->prescription_code)){ echo $billed_patient_by_pharma[0]->prescription_code;}else{ echo 'PS' . mt_rand(100000, 999999);}?>" class="invoice-input form-control" placeholder="Prescription ID" readonly="readonly"></li>
                                                        <li><input type="text" name="date" required="required" value="<?php echo date('Y-m-d')?>" class="invoice-input form-control" placeholder="Date" id="datepicker" readonly="readonly"></li>
                                                        <li><textarea id="address" value="" class="invoice-input form-control" placeholder="Address" readonly="readonly"><?php if(!empty($billed_patient_by_pharma[0]->address)){ echo $billed_patient_by_pharma[0]->address;}?></textarea></li>
                                                    </ul>
                                                </th>
                                            </tr>
                                            <!-- <tr>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody id="medicine">
                                        <?php if(!empty($prescribed_medicine_by_pharma)){
                                                foreach($prescribed_medicine_by_pharma as $value){?>
                                            <tr>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-9">
                                                <textarea name="patient_notes" class="form-control" placeholder="Patient Notes"><?php if(!empty($billed_patient_by_pharma[0]->notes)) { echo $billed_patient_by_pharma[0]->notes; }else{ echo set_value('patient_notes');}?></textarea>
