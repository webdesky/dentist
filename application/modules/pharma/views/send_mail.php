        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a class="btn btn-primary" href="<?php echo base_url('pharma/mail_list')?>"><i class="fa fa-list">&nbsp;</i> Outbox</a>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <form role="form" method="post" action="<?php echo base_url('pharma/send_mail') ?>" class="registration_form1">
                                <div class="col-md-12">
