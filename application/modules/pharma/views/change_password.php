                        ...
                        <div class="col-lg-12 col-md-12">
                            <form role="form" method="post" action="<?php echo base_url('doctor/change_password') ?>" class="registration_form1">
                                <div class="form-group"> <label class="col-md-2">Old Password * </label>
                                    <div class="col-lg-6"> <input class="form-control" type="password" placeholder="Old Password" name="old_password" autocomplete="off" id="old_password" required="required" value="<?php echo set_value('old_password');?>"> <span class="red" id="old"><?php echo form_error('old_password'); ?></span> </div>
                                </div>
