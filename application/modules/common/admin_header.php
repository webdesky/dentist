...
<head>
    ...
    <link href="<?php echo base_url('asset/dist/css/select2.css')?>" rel="stylesheet">
    <link href="<?php echo base_url('asset/dist/css/sweetalert.min.css')?>" rel="stylesheet" type="text/css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('asset/dist/css/rowReorder.dataTables.min.css')?>">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('asset/dist/css/responsive.dataTables.min.css')?>">
