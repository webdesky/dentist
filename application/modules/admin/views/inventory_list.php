    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><button class="btn btn-primary"><i class="fa fa-th-list">&nbsp;Inventory List </i></button></div>
                <!-- /.panel-heading -->
                        ...
                        <table class="table table-bordered display nowrap" cellspacing="0" width="100%"  id="notice">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX" id="tr_<?php echo $count;?>">
                                    ...
                                    <td class="center">
                                        <?php echo ucwords($value->equipment_name); ?> </td>
                                    <td class="center">
                                        <?php echo $value->no_of_equipment;  ?> </td>
                                    <td class="center">
                                        <?php echo $value->others;  ?> </td>
                                    <td class="center">
                                        <?php if($value->is_active==1){ echo 'active';}else{ echo 'deactive';}  ?> </td>
                                    <td class="center">
                                    ...
                                    |  --><a href="javascript:void(0)" onclick="delete_inventory('<?php echo $value->id?>','<?php echo $count;?>')"><i class="fa fa-trash-o" aria-hidden="true" title="delete"></i></a> | <a href="javascript:void(0)" onclick="update_inventory_status('<?php echo $value->id?>')"><i class="fa fa-hourglass-start" title="change status"></i></a> </td>
                                </tr>
                                <?php $count++; }}?> </tbody>
                        </table>
                    </div>
