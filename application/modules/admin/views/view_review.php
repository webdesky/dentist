...
.star-rating .fa-star{color: #87CEFA;}
</style>
                                    	...
                                    	<form role="form" method="post" action="<?php echo base_url('patient/doctor_review') ?>" class="registration_form1" enctype="multipart/form-data">
                                            ...
                                            <div class="col-lg-12">
                                    				<label>Q1. Would you like to recommend the doctor?</label>
                                    				    ...
                                    				    <div class="col-lg-6">
												                        <p><?php echo $review[0]->recommendation; ?></p>
                  												      </div>
                                    			</div>
                                    		</div>
                                    			...
                                    			<div class="form-group">
                                                  ...
                                                  <?php
                                                   ...
                                                   ?>
                                                        ...
                                                        <input type="checkbox" value="issue" name="improvement[]" <?php if(in_array("friendiness", $improvement)){ echo "checked" ;}?>>
                  											                <span class="cr"><i class="cr-icon fa fa-check"></i></span>
										  ...
										  <div class="col-lg-12">
										  		<div class="form-group">
                                    				...
                                    				<div class="col-lg-6">
                                    				  <p><?php  echo $review[0]->experience?></p>
												                    </div>
												                  </div>
