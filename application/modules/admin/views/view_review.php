                            ...
                            <form role="form" method="post" action="<?php echo base_url('patient/doctor_review') ?>" class="registration_form1" enctype="multipart/form-data">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6 answer">
                                            <p>
                                                <?php if(!empty($review[0]->recommendation)){ echo ucwords($review[0]->recommendation);} ?>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6 answer">
                                            <p>
                                                <?php if(!empty($review[0]->problem)) { echo ucwords($review[0]->problem); } ?>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox">
                                            <?php $improvement=explode(',', $review[0]->improvement);?>
                                        ...
                                        <div class="checkbox">
                                            <label style="font-size: 1em">
                                                <input type="checkbox" value="issue" name="improvement[]" <?php if(in_array("issue", $improvement)){ echo "checked" ;}?>>
                                                <span class="cr"><i class="cr-icon fa fa-check"></i></span>
                                                Explaination Of Health Issue
                                            </label>
                                        </div>
                                        <div class="checkbox">
                                            <label style="font-size: 1em">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6 answer">
                                            <p>
                                                <?php if(!empty($review[0]->experience)){ echo ucwords(strip_tags($review[0]->experience));}?>
                                            </p>
                                        </div>
                                    </div>
                                </div>
