                            ...
                            <form role="form" method="post" action="<?php echo base_url('doctor/add_document/'.$documents[0]->did) ?>" class="registration_form1" enctype="multipart/form-data">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <select class="wide" name="patient_id" id="patient_id" required="required">
                                                <option>--Select Patient--</option>
                                                <?php foreach ($patient as $key => $value) { ?>
                                                <option value="<?php echo $value->id; ?>" <?php if($documents[0]->id==$value->id){echo 'selected';} ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <textarea class="form-control" rows="5" id="description" name="description" placeholder="Description">
                                                <?php echo $documents[0]->description ?>
                                            </textarea>
                                        </div> <span class="red"><?php echo form_error('description'); ?></span>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="file" id="file" name="file" class="form-control"> <span class="red"><?php echo form_error('file'); ?> </div> 
                                    </div>
