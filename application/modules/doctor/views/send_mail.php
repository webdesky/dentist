        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                       <a class="btn btn-primary" href="<?php echo base_url('doctor/mail_list')?>"><i class="fa fa-list">&nbsp;</i> Mail List</a>
                </div>
                            ...
                            <form role="form" method="post" action="<?php echo base_url('doctor/send_message') ?>" class="registration_form1">
                                <div class="col-md-12">
                                    <div class="form-group"> <label class="col-md-2">Send To * </label>
                                        ...
                                        <?php }?>
                                    </select> </div> <span class="red"><?php echo form_error('reciever_id'); ?></span> </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group"> <label class="col-md-2">Subject * </label>
                                        <div class="col-md-6"> <input type="text" id="subject" name="subject" class="form-control"> </div> <span class="red"><?php echo form_error('subject'); ?></span> </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group"> <label class="col-md-2">Message * </label>
                                        <div class="col-md-6"> <textarea class="form-control" rows="5" id="message" name="message" placeholder="Message">
                                            </textarea> </div> <span class="red"><?php echo form_error('message'); ?></span>
