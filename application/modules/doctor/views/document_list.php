                        ...
                        <table class="table table-bordered display nowrap" cellspacing="0" width="100%" id="dataTables-example">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX" id="tr_<?php echo $count?>">
                                    ...
                                    <td class="center"><a href="<?php echo base_url('doctor/edit_documents/'.$value->did); ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> <a href="javascript:void(0)" onclick="delete_document('<?php echo $value->did?>','<?php echo $count?>')"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
